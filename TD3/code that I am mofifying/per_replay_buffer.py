...
class PrioritizedReplayBuffer:
    ...
    def sample_batch(self, batch_size, beta=0.4):
        ...
        return (
            np.array(batch_img, dtype=np.float32),      # (batch,1,64,128)
            ...
            np.array(batch_next_img, dtype=np.float32), # (batch,1,64,128)
